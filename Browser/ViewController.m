...
-(void)viewDidAppear:(BOOL)animated {
    ...
    [self.webview.scrollView setMaximumZoomScale:2.0];
    // [self.webview.scrollView setZoomScale:2.0];
...
-(void)handleDoubleTapMenuOrPlayPause:(UITapGestureRecognizer *)sender {
    if (sender.state == UIGestureRecognizerStateEnded) {
        ...
        UIAlertAction *mobileModeAction = [UIAlertAction
                                           ...
                                           handler:^(UIAlertAction *action)
                                           {
                                               NSDictionary *dictionary = [NSDictionary dictionaryWithObjectsAndKeys:@"Mozilla/5.0 (iPhone; CPU OS 9_1) AppleWebKit/601.2.7 (KHTML, like Gecko) Version/9.0 Mobile/12B410 Safari/601.2.7", @"UserAgent", nil];
